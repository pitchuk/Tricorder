...
(library Library_1
	...
	(compDef "PRTR5V0U2X" (originalName "PRTR5V0U2X") (compHeader (numPins 4) (numParts 1) (refDesPrefix D)
		...
		(compPin "2" (pinName "I/O 1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "I/O 2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://assets.nexperia.com/documents/data-sheet/PRTR5V0U2X.pdf")
		(attr "Height" "1.1 mm")
	)
